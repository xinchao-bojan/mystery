...
from .views import GetQuestionView, ListQuestionView, AnswerView, ListUserView, RestoreAttemptsView, \
    ...
    AddAnswerView, DeleteAnswerView, GetPromocodeView, GetPromptsView, GetStatusesView, UpdateAnswerView, UserView
...
urlpatterns = [
    ...
    path('admin/question/statuses/', GetStatusesView.as_view()),
